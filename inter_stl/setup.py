...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name), glob(os.path.join('inter_stl/launch/hw_test', '*launch.[pxy][yma]*'))),
        (os.path.join('share', package_name), glob(os.path.join('inter_stl/launch/hw_test2', '*launch.[pxy][yma]*'))),
        (os.path.join('share', package_name), glob(os.path.join('inter_stl/launch/hw_test3', '*launch.[pxy][yma]*'))),
        ...
        (os.path.join('share', package_name), glob(os.path.join('inter_stl/planners/plans/hw_test', '*.csv'))),
        (os.path.join('share', package_name), glob(os.path.join('inter_stl/planners/plans/hw_test2', '*.csv'))),
        (os.path.join('share', package_name), glob(os.path.join('inter_stl/planners/plans/hw_test3', '*.csv'))),
    ],
    ...
    entry_points={
        'console_scripts': [
                ...
                'reset = inter_stl.reset:main',

                # controllers
                'ff_rate_mpc = inter_stl.ff_rate_mpc:main',
                'ff_rate_mpc_velocity_keeping = inter_stl.ff_rate_mpc_velocity_keeping:main',
                # helpers
