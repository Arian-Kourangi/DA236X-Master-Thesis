...
def generate_launch_description():
    ...
    lf_1 = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [get_package_share_directory('inter_stl'), '/px4.launch.py']),

        launch_arguments={'id':'0', 'pose':'25,2,0', 'name':'snap', 'delay':'0', 'headless':'0', 'world' : 'frictionless_kth_final'}.items()
    )
    ...
    lf_2 = IncludeLaunchDescription(
        ...
        launch_arguments={'id':'1', 'pose':'5,15,0', 'name':'crackle', 'delay':'5', 'headless':'0', 'world' : 'frictionless_kth_final'}.items()
    )
    ...
    lf_3 = IncludeLaunchDescription(
        ...
        launch_arguments={'id':'2', 'pose':'20,5,0', 'name':'pop', 'delay':'10', 'headless':'0','world' : 'frictionless_kth_final'}.items()
    )
    ...
    #        name='plotjuggler',
    #        arguments=['-l', os.path.join(get_package_share_directory('inter_stl'), 'juggler_sitl_3.xml')]
    #))
