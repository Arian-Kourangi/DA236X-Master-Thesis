...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name), glob(os.path.join('impact_stl/launch/test1', '*launch.[pxy][yma]*'))),
        ...
        (os.path.join('share', package_name), glob(os.path.join('impact_stl/planners/plans/test1', '*.csv'))),
