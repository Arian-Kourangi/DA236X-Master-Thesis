...
def generate_launch_description():
    ...
    lf_1 = IncludeLaunchDescription(
        ...
        launch_arguments={'id':'0', 'pose':'0,5,0', 'name':'snap', 'delay':'0', 'headless':'0'}.items()
    )
    ...
    lf_2 = IncludeLaunchDescription(
        ...
        launch_arguments={'id':'1', 'pose':'-20,5,0', 'name':'crackle', 'delay':'5', 'headless':'0'}.items()
    )
    ...
    lf_3 = IncludeLaunchDescription(
        ...
        launch_arguments={'id':'2', 'pose':'-2,5,0', 'name':'pop', 'delay':'10', 'headless':'0'}.items()
    )
