...
def generate_launch_description():
    ...
    lf_1 = IncludeLaunchDescription(
        ...
        launch_arguments={'id':'0', 'pose':'-4,1,0', 'name':'snap', 'delay':'0', 'headless':'0', 'world' : 'frictionless_kth_4'}.items()
    )
    ...
    lf_2 = IncludeLaunchDescription(
        ...
        launch_arguments={'id':'1', 'pose':'-9,2,0', 'name':'crackle', 'delay':'5', 'headless':'0', 'world' : 'frictionless_kth_4'}.items()
    )
