...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            output='screen',
            emulate_tty=True,
            parameters=[{'x0':25.0, 'y0':2.0, 'z0':0.0, 'vx0':0.0, 'vy0':0.0, 'vz0':0.0},
                        {'scenario_name':'final_test'},
                        {'object_ns':'/pop'},
                        {'enable_cbf':True}]
        ),
        Node(
            ...
            # output='screen',
            emulate_tty=True,
            parameters=[{'x0':5.0, 'y0':15.0, 'z0':0.0, 'vx0':0.0, 'vy0':0.0, 'vz0':0.0},
                        {'scenario_name':'final_test'},
                        {'object_ns':'/pop'},
                        {'enable_cbf':True}]
        ),
        ...
        Node(
            ...
            output='screen',
            emulate_tty=True,
            parameters=[{'scenario_name':'final_test'}]
        ),
        Node(
            package='impact_stl',
            namespace='crackle',
